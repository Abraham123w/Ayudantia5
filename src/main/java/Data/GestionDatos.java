...
public class GestionDatos {
    public static GestionUsuarios leerArchivoUsuarios(GestionUsuarios gestionUsuarios, String direccionArchivo) {
        String textoArchivo = "";
        ...
        try {
            ...
            while ((textoArchivo = br.readLine()) != null) {
                ...
                gestionUsuarios.getUsuarios().add(new Usuario(data[0], data[1]));
            }
            br.close();
            fr.close();
        } catch (Exception e) {
